      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-4">
          <div className="bg-background-card rounded-2xl p-6 border border-text-muted/15 shadow-soft space-y-3">
            ...
            <h4 className="font-heading font-bold text-sm">Customer Support Email</h4>
            <p className="text-xs text-text-secondary">support@ecomarket.example.com</p>
          </div>

          <div className="bg-background-card rounded-2xl p-6 border border-text-muted/15 shadow-soft space-y-3">
            <Phone className="w-5 h-5 text-secondary" />
            <h4 className="font-heading font-bold text-sm">Phone Helpline</h4>
            <p className="text-xs text-text-secondary">+91 1800-123-ECO (Toll-Free)</p>
          </div>

          <div className="bg-background-card rounded-2xl p-6 border border-text-muted/15 shadow-soft space-y-3">
            <MapPin className="w-5 h-5 text-accent" />
            <h4 className="font-heading font-bold text-sm">Headquarters</h4>
            <p className="text-xs text-text-secondary">Bengaluru, Karnataka, India</p>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 bg-background-card rounded-2xl p-6 md:p-8 border border-text-muted/15 shadow-soft">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2 bg-background-muted/60 border border-text-muted/20 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-primary/40"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                className="w-full py-3 bg-primary text-white font-semibold text-xs rounded-xl hover:bg-primary-hover transition-colors flex items-center justify-center space-x-2 cursor-pointer shadow-soft"
              >
